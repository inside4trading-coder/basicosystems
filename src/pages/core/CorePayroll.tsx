      ...
      <CardContent className="p-0">
        <Table>
          ...
          <TableBody>
            {entries.map(e => (
              <TableRow key={e.id}>
                <TableCell className="text-xs">{new formatDMY(Date(e.created_at))}</TableCell>
                ...
                <Table>
                  ...
                  <TableBody>
                    {printEntries.map((l: any) => (
                      <TableRow key={l.id}>
                        <TableCell className="text-xs">{l.work_entry?.created_at ? new formatDMY(Date(l.work_entry.created_at)) : "—"}</TableCell>
