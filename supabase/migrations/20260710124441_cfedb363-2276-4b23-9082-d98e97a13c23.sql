...
-- Block 3: Confirmed Replacement Application
-- 1) resolution_data column on core_replenishment_policy_events
ALTER TABLE public.core_replenishment_policy_events
  ADD COLUMN IF NOT EXISTS resolution_data jsonb NOT NULL DEFAULT '{}'::jsonb;

-- 2) core_apply_replacement_event RPC
...
BEGIN
  ...
  -- Step 6: resolve replacement product identity
